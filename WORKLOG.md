...
## 2026-09-07 — 신규 컨셉 신설: petflowerfield (꽃밭 인생샷(펫))
- [스테이지] new-concept.mjs --stage route · 템플릿 pet:pro → cheerglam
- [프롬프트] specs/petflowerfield.prompt.txt → route 삽입 · md5 be0fb691 · 재추출 일치
...
## 2026-09-07 — BA 배선: petwild 3쌍
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(196종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS

## 2026-09-07 — petwild 출시: 홈 노출 + 배선
- [스테이지] new-concept.mjs --stage launch
- [자산] webp 2장(cards·details, q85) · 카드 1080 상한 · 상세 무축소
- [배선] detailImage 등록 + 홈 카드 주석 해제
- [목록] docs/CONCEPT_LIST.md 자동 갱신(scripts/concept-list.mjs)
...
## 2026-09-07 — 신규 컨셉 신설: petwild (야생 친구 만난 우리 아이)
- [스테이지] new-concept.mjs --stage route · 템플릿 pet:pro → cheerglam
- [프롬프트] specs/petwild.prompt.txt → route 삽입 · md5 30afadf6 · 재추출 일치
- [외모] 외모 1단계(자연) · glam-check PASS
- [배선] 8/8 · 홈 카드는 ★주석 잠금(자산 준비 후 launch 스테이지가 연다)
- [게이트] 배선 8/8 · 홈 카드 잠금 · PRO_CONCEPTS 정합 · CONCEPTS 직조회 · 프롬프트 재추출 md5 · 템플릿 무접촉 · glam-check · 변경 파일 = 예상 · 이미지 변경 0 · 빌드 전항 PASS

## 2026-09-07 — BA 배선: petbouquet 3쌍
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(195종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS

## 2026-09-07 — petbouquet 출시: 홈 노출 + 배선
- [스테이지] new-concept.mjs --stage launch
- [자산] webp 2장(cards·details, q85) · 카드 1080 상한 · 상세 무축소
- [배선] detailImage 등록 + 홈 카드 주석 해제
- [목록] docs/CONCEPT_LIST.md 자동 갱신(scripts/concept-list.mjs)
...
- [호출부] harvest·new-concept(route·refresh)가 engine·textMode를 넘긴다. 체크리스트에 예외 컨셉이면 '풀 밖 글자=결함' 한 줄
- [회귀] 기존 spec 프롬프트 22종 + 코어 정본 v1~v3 = 글자 요청 0건·전부 PASS(라이브 무영향). 단위 12항 PASS(요청 검출·부정문 제외·한글·오타·GPT 한정·머리말·7자·숫자·선택 규칙·봉쇄줄·브랜드 금지줄)
- [문서] CONCEPT_FACTORY.md §1-6 예외 문단 · §3 선택 칸 textMode · §5 예외 프롬프트 4요소 규격
...
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(194종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS

## 2026-09-07 — product360 출시: 홈 노출 + 배선
- [스테이지] new-concept.mjs --stage launch
- [자산] webp 2장(cards·details, q85) · 카드 1080 상한 · 상세 무축소
- [배선] detailImage 등록 + 홈 카드 주석 해제
- [목록] docs/CONCEPT_LIST.md 자동 갱신(scripts/concept-list.mjs)
...
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(193종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS

## 2026-09-07 — foodsketch 출시: 홈 노출 + 배선
- [스테이지] new-concept.mjs --stage launch
- [자산] webp 2장(cards·details, q85) · 카드 1080 상한 · 상세 무축소
- [배선] detailImage 등록 + 홈 카드 주석 해제
- [목록] docs/CONCEPT_LIST.md 자동 갱신(scripts/concept-list.mjs)
...
## 2026-09-07 — 신규 컨셉 신설: foodsketch (음식만 스케치)
- [스테이지] new-concept.mjs --stage route · 템플릿 food:gpt → gyaru
- [프롬프트] specs/foodsketch.prompt.txt → route 삽입 · md5 247c6499 · 재추출 일치
- [외모] 외모 1단계(자연) · glam-check PASS
- [배선] 8/8 · 홈 카드는 ★주석 잠금(자산 준비 후 launch 스테이지가 연다)
- [게이트] 배선 8/8 · 홈 카드 잠금 · PRO_CONCEPTS 정합 · CONCEPTS 직조회 · 프롬프트 재추출 md5 · 템플릿 무접촉 · glam-check · 변경 파일 = 예상 · 이미지 변경 0 · 빌드 전항 PASS

## 2026-09-07 — BA 배선: fooddoodle 3쌍
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(192종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS

## 2026-09-07 — fooddoodle 출시: 홈 노출 + 배선
- [스테이지] new-concept.mjs --stage launch
- [자산] webp 2장(cards·details, q85) · 카드 1080 상한 · 상세 무축소
- [배선] detailImage 등록 + 홈 카드 주석 해제
- [목록] docs/CONCEPT_LIST.md 자동 갱신(scripts/concept-list.mjs)
...
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(191종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS

## 2026-09-06 — plantshot 출시: 홈 노출 + 배선
- [스테이지] new-concept.mjs --stage launch
- [자산] webp 2장(cards·details, q85) · 카드 1080 상한 · 상세 무축소
- [배선] detailImage 등록 + 홈 카드 주석 해제
- [목록] docs/CONCEPT_LIST.md 자동 갱신(scripts/concept-list.mjs)
...
## 2026-09-06 — 신규 컨셉 신설: plantshot (반려식물 화보)
- [스테이지] new-concept.mjs --stage route · 템플릿 product:gpt → gyaru
- [프롬프트] specs/plantshot.prompt.txt → route 삽입 · md5 c7d35a65 · 재추출 일치
- [외모] 외모 1단계(자연) · glam-check PASS
- [배선] 8/8 · 홈 카드는 ★주석 잠금(자산 준비 후 launch 스테이지가 연다)
- [게이트] 배선 8/8 · 홈 카드 잠금 · PRO_CONCEPTS 정합 · CONCEPTS 직조회 · 프롬프트 재추출 md5 · 템플릿 무접촉 · glam-check · 변경 파일 = 예상 · 이미지 변경 0 · 빌드 전항 PASS

## 2026-09-06 — BA 배선: bouquetshot 3쌍
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(190종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS

## 2026-09-06 — bouquetshot 출시: 홈 노출 + 배선
- [스테이지] new-concept.mjs --stage launch
- [자산] webp 2장(cards·details, q85) · 카드 1080 상한 · 상세 무축소
- [배선] detailImage 등록 + 홈 카드 주석 해제
- [목록] docs/CONCEPT_LIST.md 자동 갱신(scripts/concept-list.mjs)
...
## 2026-09-06 — 신규 컨셉 신설: bouquetshot (꽃다발 상품컷)
- [스테이지] new-concept.mjs --stage route · 템플릿 product:gpt → gyaru
- [프롬프트] specs/bouquetshot.prompt.txt → route 삽입 · md5 d9d7d72a · 재추출 일치
- [외모] 외모 1단계(자연) · glam-check PASS
- [배선] 8/8 · 홈 카드는 ★주석 잠금(자산 준비 후 launch 스테이지가 연다)
- [게이트] 배선 8/8 · 홈 카드 잠금 · PRO_CONCEPTS 정합 · CONCEPTS 직조회 · 프롬프트 재추출 md5 · 템플릿 무접촉 · glam-check · 변경 파일 = 예상 · 이미지 변경 0 · 빌드 전항 PASS

## 2026-09-06 — BA 배선: nailshot 3쌍
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(189종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS

## 2026-09-06 — nailshot 출시: 홈 노출 + 배선
- [스테이지] new-concept.mjs --stage launch
- [자산] webp 2장(cards·details, q85) · 카드 1080 상한 · 상세 무축소
- [배선] detailImage 등록 + 홈 카드 주석 해제
- [목록] docs/CONCEPT_LIST.md 자동 갱신(scripts/concept-list.mjs)
...
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(188종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS

## 2026-09-06 — sketch2real 출시: 홈 노출 + 배선
- [스테이지] new-concept.mjs --stage launch
- [자산] webp 2장(cards·details, q85) · 카드 1080 상한 · 상세 무축소
- [배선] detailImage 등록 + 홈 카드 주석 해제
- [목록] docs/CONCEPT_LIST.md 자동 갱신(scripts/concept-list.mjs)
...
## 2026-09-06 — 신규 컨셉 신설: sketch2real (스케치 실물화)
- [스테이지] new-concept.mjs --stage route · 템플릿 product:gpt → gyaru
- [프롬프트] specs/sketch2real.prompt.txt → route 삽입 · md5 f00edbe5 · 재추출 일치
- [외모] 외모 1단계(자연) · glam-check PASS
- [배선] 8/8 · 홈 카드는 ★주석 잠금(자산 준비 후 launch 스테이지가 연다)
- [게이트] 배선 8/8 · 홈 카드 잠금 · PRO_CONCEPTS 정합 · CONCEPTS 직조회 · 프롬프트 재추출 md5 · 템플릿 무접촉 · glam-check · 변경 파일 = 예상 · 이미지 변경 0 · 빌드 전항 PASS

## 2026-09-06 — BA 배선: carad 3쌍
- [스테이지] new-concept.mjs --stage ba
- [자산] 768×960(4:5) webp q85 6장
- [배선] BA_LIVE 등록(187종) + pairs=[1, 2, 3]
- [게이트] BA_LIVE 등록 · pairs = 실제 쌍 수 · 자산 실재 · 기존 BA 무접촉 · 변경 파일 = 예상 · 원료 스테이징 0 · 빌드 전항 PASS
