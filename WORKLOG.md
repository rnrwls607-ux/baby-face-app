...
## 2026-07-17 (이어서) — y2k·halloween 보정 공식 이식 + ★신규 8종 오픈 (83종 체제)
- 한 일:
  - [y2k] 단일 프롬프트 교체(82213a1): RETRO FIREWALL(복고는 스타일링만, 얼굴은 2026 한국 기준) + 플래시 RELIGHT(디카 직광, 배경 어둑) + 밤거리 네온 씬. "디카 무드·현대 화질" 이중 방어, 타임스탬프 금지
  - [halloween] B방식 교체(82213a1): HALLOWEEN_CORE+FINISH, 3변신 키(vampire·witch·fairy) 유지 — 늙음 금지·공포 금지(피·송곳니·컬러렌즈)·"밝은 얼굴 in 무디한 세계" 조명 규칙
  - [★신규 8종 오픈] 3ee5dd9(+2,290줄, 18파일): hanbok·retro90·hocance·redcarpet·birthday·job(3칩 pilot/doctor/ceo)·sporty(2칩 tennis/golf)·flower. 공통 CORE+씬 블록+FINISH 조합, y2k(단일)·halloween(칩) 템플릿 복제. 6곳 배선 전수 grep 통과, 칩 옵션 전달 경로 추적 통과(era 버그 전례 방어). 이모지 폴백 즉시 노출 — "완전체만 노출" 원칙의 의도적 예외(상세페이지 작업 직결 전제)
  - 보정 공식 컨셉 11종 체제(travel+y2k+halloween+신규8). 신규 8종 전부 무료 — 벌크 스위치 때 코인 일괄
- 다음에 할 것: 상세페이지 10종(신규8+halloween 애프터+y2k 리프레시 판단) — halloween부터(킷 발송됨, 비포3명→애프터7장→배치→오픈). 신규 8종 실측은 애프터 제작에 흡수
- 주의/메모: 감시 포인트 — 한복 쪽머리 늙음 / 90년대 저화질 새기 / 레드카펫 벽 글자 / 생일 케이크 글자 / 파일럿 모자 그림자 / 라켓·클럽 손 왜곡 / 꽃 얼굴 가림 / 칩형은 칩 전환 시 씬 실변경 확인. 3변신 갤러리·4곳 그리드류 킬러 섹션은 반드시 동일 인물
