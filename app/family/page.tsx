...
export default function FamilyPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      void addToHistory(data.output, "가족 스튜디오", Array.isArray(data.originalUrls) ? data.originalUrls : undefined);
    } catch (e: unknown) {
      clearTimeout(tid);
  ...
  const handleDownload = () => { void saveImage(result, "family.png"); };
  const handleShare = () => { void shareImage(result, "family.png", "MOSPIC에서 만든 사진이에요 · mospic.com"); };
