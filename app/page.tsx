...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "bizwhite", title: "화이트 셔츠 프로필", subtitle: "편안하고 단정한 전문가", emoji: "🤍", accent: "#FFF0F5", badge: "NEW", tags: ["비즈니스"], go: "bizwhite" },
