...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "bizshirring", title: "셔링 블라우스 프로필", subtitle: "우아하고 고급스러운 무드", emoji: "🎀", accent: "#F7F0E9", badge: "NEW", tags: ["비즈니스"], go: "bizshirring" },
      { id: "bizviolet", title: "바이올렛 스커트 프로필", subtitle: "차분하고 세련된 분위기", emoji: "💜", accent: "#F0EBF7", badge: "NEW", tags: ["비즈니스"], go: "bizviolet" },
      { id: "bizblueskirt", title: "블루 스커트 프로필", subtitle: "깨끗하고 산뜻한 느낌", emoji: "💙", accent: "#EAF0F8", badge: "NEW", tags: ["비즈니스"], go: "bizblueskirt" },
      { id: "bizburgundy", title: "버건디 슬랙스 프로필", subtitle: "자신감과 열정을 드러내는", emoji: "🍷", accent: "#F6EAEC", badge: "NEW", tags: ["비즈니스"], go: "bizburgundy" },
      { id: "bizkhaki", title: "카키 수트 프로필", subtitle: "모던하고 세련된 무드", emoji: "🫒", accent: "#F0EEE4", badge: "NEW", tags: ["비즈니스"], go: "bizkhaki" },
      { id: "bizblackdress", title: "블랙 원피스 프로필", subtitle: "시크하고 세련된 무드", emoji: "🖤", accent: "#EFEFF1", badge: "NEW", tags: ["비즈니스"], go: "bizblackdress" },
      { id: "bizbluegray", title: "블루&그레이 미니원피스 프로필", subtitle: "발랄하고 산뜻한 인상", emoji: "💙", accent: "#ECEFF4", badge: "NEW", tags: ["비즈니스"], go: "bizbluegray" },
      { id: "bizpinstripe", title: "핀스트라이프 수트 프로필", subtitle: "클래식하고 자신감 있는", emoji: "📏", accent: "#ECEEF1", badge: "NEW", tags: ["비즈니스"], go: "bizpinstripe" },
      { id: "bizcheck", title: "체크 블레이저 수트 프로필", subtitle: "우아하고 클래식한 패턴", emoji: "🏁", accent: "#EFEEEC", badge: "NEW", tags: ["비즈니스"], go: "bizcheck" },
      { id: "bizknitdress", title: "카멜 니트 원피스 프로필", subtitle: "따뜻하면서 단정한 무드", emoji: "🐫", accent: "#F3EDE2", badge: "NEW", tags: ["비즈니스"], go: "bizknitdress" },
