...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "bizmnavy", title: "남성 네이비 정장", subtitle: "믿음직한 프로페셔널", emoji: "💼", accent: "#EAF3FF", badge: "NEW", tags: ["비즈니스"], go: "bizmnavy" },
      { id: "bizmcharcoal", title: "남성 차콜 정장", subtitle: "비즈니스 스탠다드", emoji: "💼", accent: "#ECEEF1", badge: "NEW", tags: ["비즈니스"], go: "bizmcharcoal" },
      { id: "bizmblack", title: "남성 블랙 정장", subtitle: "격식 있는 클래식", emoji: "🖤", accent: "#F0F1F4", badge: "NEW", tags: ["비즈니스"], go: "bizmblack" },
      { id: "bizmlightgray", title: "남성 라이트그레이 정장", subtitle: "밝고 부드러운 인상", emoji: "🤵", accent: "#F2F3F5", badge: "NEW", tags: ["비즈니스"], go: "bizmlightgray" },
      { id: "bizmvest", title: "남성 쓰리피스 (조끼)", subtitle: "무게감 있는 임원룩", emoji: "💼", accent: "#ECEDF0", badge: "NEW", tags: ["비즈니스"], go: "bizmvest" },
      { id: "bizmbeige", title: "남성 베이지 정장", subtitle: "따뜻하고 친근한", emoji: "🧥", accent: "#F5EFE6", badge: "NEW", tags: ["비즈니스"], go: "bizmbeige" },
      { id: "bizmblazer", title: "남성 네이비 블레이저", subtitle: "노타이 비즈캐주얼", emoji: "🧥", accent: "#EAF3FF", badge: "NEW", tags: ["비즈니스"], go: "bizmblazer" },
      { id: "bizmturtle", title: "남성 블레이저 터틀넥", subtitle: "모던 미니멀", emoji: "⬛", accent: "#EDEEF0", badge: "NEW", tags: ["비즈니스"], go: "bizmturtle" },
      { id: "bizmdb", title: "남성 더블브레스티드", subtitle: "존재감 있는 실루엣", emoji: "🤵", accent: "#E9EEF6", badge: "NEW", tags: ["비즈니스"], go: "bizmdb" },
      { id: "bizmknittie", title: "남성 니트타이 재킷", subtitle: "젊은 전문직 세미포멀", emoji: "👔", accent: "#EDEFEA", badge: "NEW", tags: ["비즈니스"], go: "bizmknittie" },
