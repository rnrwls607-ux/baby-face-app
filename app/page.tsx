...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "remindwedding", title: "리마인드 웨딩", subtitle: "부모님 웨딩사진, 다시 한 번", emoji: "💒", accent: "#FFF1E0", badge: "NEW", tags: ["가족"], go: "remindwedding" },
      { id: "selfwedding", title: "셀프웨딩 화보", subtitle: "우리끼리, 웨딩 화보", emoji: "💍", accent: "#FCE8EF", badge: "NEW", tags: ["커플"], go: "selfwedding" },
      { id: "duofamily", title: "둘이서 가족사진", subtitle: "둘이서 남기는 가족사진", emoji: "🏠", accent: "#E7F7EA", badge: "NEW", tags: ["가족"], go: "duofamily" },
      { id: "family", title: "가족 스튜디오 화보", subtitle: "온 가족이 한 장에", emoji: "👨‍👩‍👧‍👦", accent: "#E7F7EA", badge: "NEW", tags: ["가족"], go: "family" },
      { id: "familyhanbok", title: "명절 한복 2인", subtitle: "둘이 함께, 명절 한복", emoji: "🏮", accent: "#FFF1E0", badge: "NEW", tags: ["가족"], go: "familyhanbok" },
