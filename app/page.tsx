...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "idwarmbob", title: "웜브라운 단발 증명사진", subtitle: "따뜻하고 포근한 무드", emoji: "🤎", accent: "#F5EEE4", badge: "NEW", tags: ["증명사진"], go: "idwarmbob" },
      { id: "idhime", title: "밀크브라운 히메컷 증명사진", subtitle: "러블리하고 부드러운", emoji: "🎀", accent: "#F7ECEA", badge: "NEW", tags: ["증명사진"], go: "idhime" },
      { id: "idashwave", title: "애쉬 웨이브 증명사진", subtitle: "세련되고 몽환적인", emoji: "🩶", accent: "#EEEEF0", badge: "NEW", tags: ["증명사진"], go: "idashwave" },
      { id: "idlowbun", title: "로우번 터틀넥 증명사진", subtitle: "시크하고 세련된 무드", emoji: "🖤", accent: "#F5EBEA", badge: "NEW", tags: ["증명사진"], go: "idlowbun" },
      { id: "idburgundy", title: "버건디 오프숄더 프로필", subtitle: "우아하고 여성스러운 화보", emoji: "🍷", accent: "#F6E9E6", badge: "NEW", tags: ["증명사진"], go: "idburgundy" },
      { id: "iddandy", title: "댄디 베스트 증명사진", subtitle: "시원하고 댄디한 무드", emoji: "🩵", accent: "#EAEFF4", badge: "NEW", tags: ["증명사진"], go: "iddandy" },
      { id: "iddownperm", title: "다운펌 화이트셔츠 증명사진", subtitle: "청량하고 산뜻한 첫인상", emoji: "🩵", accent: "#EAF3FB", badge: "NEW", tags: ["증명사진"], go: "iddownperm" },
      { id: "idnavysuit", title: "가르마 네이비수트 증명사진", subtitle: "신뢰감 있는 프로페셔널", emoji: "💙", accent: "#EAEFF7", badge: "NEW", tags: ["증명사진"], go: "idnavysuit" },
      { id: "idbeigeblazer", title: "소프트펌 베이지 증명사진", subtitle: "세련되고 따뜻한 무드", emoji: "🤎", accent: "#F3ECE3", badge: "NEW", tags: ["증명사진"], go: "idbeigeblazer" },
      { id: "idhenley", title: "투블럭 헨리넥 증명사진", subtitle: "감각적이고 모던한", emoji: "🌿", accent: "#ECEFEA", badge: "NEW", tags: ["증명사진"], go: "idhenley" },
