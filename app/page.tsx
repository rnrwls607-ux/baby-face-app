...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "coupletravel", title: "커플 여행 스냅", subtitle: "둘이 함께, 여행 스냅", emoji: "✈️", accent: "#DFF3FF", badge: "NEW", tags: ["커플"], go: "coupletravel" },
      ...
      { id: "familypet", title: "반려가족 사진", subtitle: "우리 애도 가족이니까", emoji: "🐾", accent: "#DCEBFF", badge: "NEW", tags: ["가족"], go: "familypet" },
