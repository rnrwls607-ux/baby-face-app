...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "pendrawing", title: "펜 드로잉 초상", subtitle: "한 장의 손그림 초상화", emoji: "✒️", accent: "#F2F0EC", badge: "NEW", tags: ["재미"], go: "pendrawing" },
      { id: "oilportrait", title: "유화 명화 초상", subtitle: "미술관에 걸린 나", emoji: "🖼️", accent: "#EDE4D8", badge: "NEW", tags: ["재미"], go: "oilportrait" },
      { id: "softanime", title: "감성 애니 초상", subtitle: "애니메이션 한 장면처럼", emoji: "🌿", accent: "#E7F7EA", badge: "NEW", tags: ["재미"], go: "softanime" },
      { id: "retroanime", title: "레트로 애니 초상", subtitle: "90년대 애니 한 장면", emoji: "📼", accent: "#FFE8D6", badge: "NEW", tags: ["재미"], go: "retroanime" },
      { id: "popart", title: "팝아트 포스터", subtitle: "원색으로 물든 나", emoji: "🎨", accent: "#FFE0EC", badge: "NEW", tags: ["재미"], go: "popart" },
      { id: "marble", title: "대리석 조각상", subtitle: "미술관에 선 나", emoji: "🏛️", accent: "#EFF0F3", badge: "NEW", tags: ["재미"], go: "marble" },
      { id: "chibifigure", title: "미니 피규어", subtitle: "책상 위 나의 피규어", emoji: "🧸", accent: "#FFE9D6", badge: "NEW", tags: ["재미"], go: "chibifigure" },
      { id: "clayfigure", title: "클레이 피규어", subtitle: "손으로 빚은 나", emoji: "🏺", accent: "#F6E7DA", badge: "NEW", tags: ["재미"], go: "clayfigure" },
      { id: "stitchart", title: "자수 초상", subtitle: "한 땀 한 땀 수놓은 나", emoji: "🧵", accent: "#FBE7EC", badge: "NEW", tags: ["재미"], go: "stitchart" },
      { id: "pixelart", title: "픽셀 아트", subtitle: "도트로 그린 나의 세계", emoji: "👾", accent: "#E3ECFF", badge: "NEW", tags: ["재미"], go: "pixelart" },
      { id: "stainedglass", title: "스테인드글라스", subtitle: "빛으로 물든 초상", emoji: "🪟", accent: "#E2E9FA", badge: "NEW", tags: ["재미"], go: "stainedglass" },
      { id: "neonsign", title: "네온사인 초상", subtitle: "어둠 속에 빛나는 나", emoji: "💡", accent: "#F6E1F5", badge: "NEW", tags: ["재미"], go: "neonsign" },
      { id: "paperart", title: "페이퍼 아트", subtitle: "겹겹이 오려 만든 나", emoji: "✂️", accent: "#FBEEDF", badge: "NEW", tags: ["재미"], go: "paperart" },
      { id: "stickerpack", title: "스티커팩", subtitle: "여섯 컷 나만의 스티커", emoji: "🏷️", accent: "#FFF0D9", badge: "NEW", tags: ["재미"], go: "stickerpack" },
      { id: "toon3d", title: "3D 캐릭터 초상", subtitle: "극장판 주인공이 된 나", emoji: "🎬", accent: "#E7EDFB", badge: "NEW", tags: ["재미"], go: "toon3d" },
