...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "petbirthday", title: "펫 생일 파티", subtitle: "우리 아이 생일, 화보로", emoji: "🎂", accent: "#FFE8F0", badge: "NEW", tags: ["반려동물"], go: "petbirthday" },
      { id: "petmemorial", title: "무지개다리 초상", subtitle: "소중한 아이를 오래 간직하는 초상", emoji: "🌈", accent: "#EFEAFF", badge: "NEW", tags: ["반려동물"], go: "petmemorial" },
      { id: "petceo", title: "펫 CEO 출근", subtitle: "오늘부터 우리 아이가 회장님", emoji: "👔", accent: "#E8EAED", badge: "NEW", tags: ["반려동물"], go: "petceo" },
      { id: "petgraduation", title: "펫 졸업사진", subtitle: "유치원 졸업을 축하하며", emoji: "🎓", accent: "#E7F7EA", badge: "NEW", tags: ["반려동물"], go: "petgraduation" },
      { id: "petminhwa", title: "조선 민화 초상", subtitle: "우리 아이를 민화 명작으로", emoji: "🖼️", accent: "#FFF3E2", badge: "NEW", tags: ["반려동물"], go: "petminhwa" },
      { id: "petroyal", title: "로얄 유화 초상", subtitle: "왕의 초상이 된 우리 아이", emoji: "👑", accent: "#F3E8DC", badge: "NEW", tags: ["반려동물"], go: "petroyal" },
      { id: "pettwo", title: "펫 둘이서", subtitle: "두 아이를 한 장에", emoji: "🐾", accent: "#DCEBFF", badge: "NEW", tags: ["반려동물"], go: "pettwo" },
      { id: "petjob", title: "펫 직업 변신", subtitle: "우리 아이의 첫 출근", emoji: "🩺", accent: "#E1ECFF", badge: "NEW", tags: ["반려동물"], go: "petjob" },
