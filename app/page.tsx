...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "y2k", title: "Y2K 하이틴", subtitle: "2000년대 하이틴 스타로", emoji: "🕹️", accent: "#FCE8EF", badge: "NEW", tags: ["재미"], go: "y2k" },
      { id: "roman", title: "로판 웹툰 주인공", subtitle: "웹툰 표지 주인공으로", emoji: "👑", accent: "#EFEAFF", badge: "NEW", tags: ["재미"], go: "roman" },
      { id: "clay", title: "클레이 아트", subtitle: "점토로 빚은 우리", emoji: "🧱", accent: "#FFEFD6", badge: "NEW", tags: ["재미"], go: "clay" },
      { id: "goods", title: "굿즈 미리보기", subtitle: "나·우리 애가 아크릴 굿즈로", emoji: "🔑", accent: "#FFE9D6", badge: "NEW", tags: ["재미"], go: "goods" },
      { id: "luxe", title: "럭셔리 매거진 화보", subtitle: "매거진 커버 속 나", emoji: "🖤", accent: "#E8EAED", badge: "NEW", tags: ["인생샷"], go: "luxe" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "homecafe", title: "홈카페 감성 사진", subtitle: "인스타 감성 한 장", emoji: "☕", accent: "#F5E9DC", badge: "NEW", tags: ["음식"], go: "homecafe" },
