...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "bizbeige", title: "베이지 정장 프로필", subtitle: "부드럽고 따뜻한 전문가", emoji: "🤎", accent: "#F3ECE3", badge: "NEW", tags: ["비즈니스"], go: "bizbeige" },
      { id: "bizlavender", title: "라벤더 정장 프로필", subtitle: "화사하고 부드러운 첫인상", emoji: "💜", accent: "#F0EBFA", badge: "NEW", tags: ["비즈니스"], go: "bizlavender" },
      { id: "bizgray", title: "그레이 정장 프로필", subtitle: "차분하고 전문적인 인상", emoji: "🩶", accent: "#EFF0F2", badge: "NEW", tags: ["비즈니스"], go: "bizgray" },
      { id: "bizknit", title: "니트 가디건 프로필", subtitle: "친근하고 단정한 분위기", emoji: "🧶", accent: "#F5EFE6", badge: "NEW", tags: ["비즈니스"], go: "bizknit" },
      { id: "bizchiffon", title: "쉬폰 블라우스 프로필", subtitle: "밝고 화사한 여성 프로필", emoji: "🌸", accent: "#FCEFF3", badge: "NEW", tags: ["비즈니스"], go: "bizchiffon" },
      { id: "bizpinkjacket", title: "핑크 트위드 재킷 프로필", subtitle: "우아하고 화사한 셋업", emoji: "🌷", accent: "#FCE8EF", badge: "NEW", tags: ["비즈니스"], go: "bizpinkjacket" },
      { id: "bizcreamdress", title: "크림 원피스 프로필", subtitle: "은은하고 우아한 여성 프로필", emoji: "🎀", accent: "#FBF3E8", badge: "NEW", tags: ["비즈니스"], go: "bizcreamdress" },
      { id: "biznavyblouse", title: "네이비 블라우스 프로필", subtitle: "단정하고 클래식한 조합", emoji: "💙", accent: "#EAEFF7", badge: "NEW", tags: ["비즈니스"], go: "biznavyblouse" },
      { id: "bizskyblouse", title: "스카이블루 블라우스 프로필", subtitle: "맑고 산뜻한 첫인상", emoji: "🩵", accent: "#EAF3FB", badge: "NEW", tags: ["비즈니스"], go: "bizskyblouse" },
      { id: "bizpinktweed", title: "핑크 트위드 원피스 프로필", subtitle: "격식 있는 우아한 원피스", emoji: "🌸", accent: "#FCE8EF", badge: "NEW", tags: ["비즈니스"], go: "bizpinktweed" },
