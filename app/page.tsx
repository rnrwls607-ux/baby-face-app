...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  {
    ...
    items: [
      ...
      { id: "pop-bizpinkjacket", title: "핑크 트위드 재킷 프로필", subtitle: "우아하고 화사한 셋업", emoji: "🌷", accent: "#FCE8EF", image: "/cards/bizpinkjacket.png", badge: "NEW", tags: ["비즈니스"], go: "bizpinkjacket" },
      { id: "pop-bizmnavy", title: "남성 네이비 정장", subtitle: "믿음직한 프로페셔널", emoji: "💼", accent: "#EAF3FF", image: "/cards/bizmnavy.png", badge: "NEW", tags: ["비즈니스"], go: "bizmnavy" },
      { id: "pop-interior", title: "인테리어 비포/애프터", subtitle: "빈 방에 가구를", emoji: "🛋️", accent: "#FFEFD6", badge: "NEW", tags: ["인테리어"], image: "/cards/interior.png", go: "interior" },
      { id: "pop-idtweed", title: "반묶음 트위드 증명사진", subtitle: "포멀한 러블리 무드", emoji: "🎀", accent: "#F9EEE8", image: "/cards/idtweed.png", badge: "NEW", tags: ["증명사진"], go: "idtweed" },
    ],
  },
  {
    ...
    items: [
      ...
      { id: "pet", title: "반려동물 증명사진", subtitle: "정장 입은 우리 아이", emoji: "🐶", accent: "#FFF1E0", badge: "NEW", tags: ["반려동물"], image: "/cards/pet.png", go: "pet" },
      ...
      { id: "bizmnavy", title: "남성 네이비 정장", subtitle: "믿음직한 프로페셔널", emoji: "💼", accent: "#EAF3FF", image: "/cards/bizmnavy.png", badge: "NEW", tags: ["비즈니스"], go: "bizmnavy" },
      { id: "bizmcharcoal", title: "남성 차콜 정장", subtitle: "비즈니스 스탠다드", emoji: "💼", accent: "#ECEEF1", image: "/cards/bizmcharcoal.png", badge: "NEW", tags: ["비즈니스"], go: "bizmcharcoal" },
      { id: "bizmblack", title: "남성 블랙 정장", subtitle: "격식 있는 클래식", emoji: "🖤", accent: "#F0F1F4", image: "/cards/bizmblack.png", badge: "NEW", tags: ["비즈니스"], go: "bizmblack" },
      { id: "bizmlightgray", title: "남성 라이트그레이 정장", subtitle: "밝고 부드러운 인상", emoji: "🤵", accent: "#F2F3F5", image: "/cards/bizmlightgray.png", badge: "NEW", tags: ["비즈니스"], go: "bizmlightgray" },
      { id: "bizmvest", title: "남성 쓰리피스 (조끼)", subtitle: "무게감 있는 임원룩", emoji: "💼", accent: "#ECEDF0", image: "/cards/bizmvest.png", badge: "NEW", tags: ["비즈니스"], go: "bizmvest" },
      { id: "bizmbeige", title: "남성 베이지 정장", subtitle: "따뜻하고 친근한", emoji: "🧥", accent: "#F5EFE6", image: "/cards/bizmbeige.png", badge: "NEW", tags: ["비즈니스"], go: "bizmbeige" },
      { id: "bizmblazer", title: "남성 네이비 블레이저", subtitle: "노타이 비즈캐주얼", emoji: "🧥", accent: "#EAF3FF", image: "/cards/bizmblazer.png", badge: "NEW", tags: ["비즈니스"], go: "bizmblazer" },
      { id: "bizmturtle", title: "남성 블레이저 터틀넥", subtitle: "모던 미니멀", emoji: "⬛", accent: "#EDEEF0", image: "/cards/bizmturtle.png", badge: "NEW", tags: ["비즈니스"], go: "bizmturtle" },
      { id: "bizmdb", title: "남성 더블브레스티드", subtitle: "존재감 있는 실루엣", emoji: "🤵", accent: "#E9EEF6", image: "/cards/bizmdb.png", badge: "NEW", tags: ["비즈니스"], go: "bizmdb" },
      { id: "bizmknittie", title: "남성 니트타이 재킷", subtitle: "젊은 전문직 세미포멀", emoji: "👔", accent: "#EDEFEA", image: "/cards/bizmknittie.png", badge: "NEW", tags: ["비즈니스"], go: "bizmknittie" },
      ...
      { id: "bizbeige", title: "베이지 정장 프로필", subtitle: "부드럽고 따뜻한 전문가", emoji: "🤎", accent: "#F3ECE3", image: "/cards/bizbeige.png", badge: "NEW", tags: ["비즈니스"], go: "bizbeige" },
      { id: "bizlavender", title: "라벤더 정장 프로필", subtitle: "화사하고 부드러운 첫인상", emoji: "💜", accent: "#F0EBFA", image: "/cards/bizlavender.png", badge: "NEW", tags: ["비즈니스"], go: "bizlavender" },
      { id: "bizgray", title: "그레이 정장 프로필", subtitle: "차분하고 전문적인 인상", emoji: "🩶", accent: "#EFF0F2", image: "/cards/bizgray.png", badge: "NEW", tags: ["비즈니스"], go: "bizgray" },
      { id: "bizknit", title: "니트 가디건 프로필", subtitle: "친근하고 단정한 분위기", emoji: "🧶", accent: "#F5EFE6", image: "/cards/bizknit.png", badge: "NEW", tags: ["비즈니스"], go: "bizknit" },
      { id: "bizchiffon", title: "쉬폰 블라우스 프로필", subtitle: "밝고 화사한 여성 프로필", emoji: "🌸", accent: "#FCEFF3", image: "/cards/bizchiffon.png", badge: "NEW", tags: ["비즈니스"], go: "bizchiffon" },
      { id: "bizpinkjacket", title: "핑크 트위드 재킷 프로필", subtitle: "우아하고 화사한 셋업", emoji: "🌷", accent: "#FCE8EF", image: "/cards/bizpinkjacket.png", badge: "NEW", tags: ["비즈니스"], go: "bizpinkjacket" },
      { id: "bizcreamdress", title: "크림 원피스 프로필", subtitle: "은은하고 우아한 여성 프로필", emoji: "🎀", accent: "#FBF3E8", image: "/cards/bizcreamdress.png", badge: "NEW", tags: ["비즈니스"], go: "bizcreamdress" },
      { id: "biznavyblouse", title: "네이비 블라우스 프로필", subtitle: "단정하고 클래식한 조합", emoji: "💙", accent: "#EAEFF7", image: "/cards/biznavyblouse.png", badge: "NEW", tags: ["비즈니스"], go: "biznavyblouse" },
      { id: "bizskyblouse", title: "스카이블루 블라우스 프로필", subtitle: "맑고 산뜻한 첫인상", emoji: "🩵", accent: "#EAF3FB", image: "/cards/bizskyblouse.png", badge: "NEW", tags: ["비즈니스"], go: "bizskyblouse" },
      { id: "bizpinktweed", title: "핑크 트위드 원피스 프로필", subtitle: "격식 있는 우아한 원피스", emoji: "🌸", accent: "#FCE8EF", image: "/cards/bizpinktweed.png", badge: "NEW", tags: ["비즈니스"], go: "bizpinktweed" },
      { id: "bizshirring", title: "셔링 블라우스 프로필", subtitle: "우아하고 고급스러운 무드", emoji: "🎀", accent: "#F7F0E9", image: "/cards/bizshirring.png", badge: "NEW", tags: ["비즈니스"], go: "bizshirring" },
      { id: "bizviolet", title: "바이올렛 스커트 프로필", subtitle: "차분하고 세련된 분위기", emoji: "💜", accent: "#F0EBF7", image: "/cards/bizviolet.png", badge: "NEW", tags: ["비즈니스"], go: "bizviolet" },
      { id: "bizblueskirt", title: "블루 스커트 프로필", subtitle: "깨끗하고 산뜻한 느낌", emoji: "💙", accent: "#EAF0F8", image: "/cards/bizblueskirt.png", badge: "NEW", tags: ["비즈니스"], go: "bizblueskirt" },
      { id: "bizburgundy", title: "버건디 슬랙스 프로필", subtitle: "자신감과 열정을 드러내는", emoji: "🍷", accent: "#F6EAEC", image: "/cards/bizburgundy.png", badge: "NEW", tags: ["비즈니스"], go: "bizburgundy" },
      { id: "bizkhaki", title: "카키 수트 프로필", subtitle: "모던하고 세련된 무드", emoji: "🫒", accent: "#F0EEE4", image: "/cards/bizkhaki.png", badge: "NEW", tags: ["비즈니스"], go: "bizkhaki" },
      { id: "bizblackdress", title: "블랙 원피스 프로필", subtitle: "시크하고 세련된 무드", emoji: "🖤", accent: "#EFEFF1", image: "/cards/bizblackdress.png", badge: "NEW", tags: ["비즈니스"], go: "bizblackdress" },
      { id: "bizbluegray", title: "블루&그레이 미니원피스 프로필", subtitle: "발랄하고 산뜻한 인상", emoji: "💙", accent: "#ECEFF4", image: "/cards/bizbluegray.png", badge: "NEW", tags: ["비즈니스"], go: "bizbluegray" },
      { id: "bizpinstripe", title: "핀스트라이프 수트 프로필", subtitle: "클래식하고 자신감 있는", emoji: "📏", accent: "#ECEEF1", image: "/cards/bizpinstripe.png", badge: "NEW", tags: ["비즈니스"], go: "bizpinstripe" },
      { id: "bizcheck", title: "체크 블레이저 수트 프로필", subtitle: "우아하고 클래식한 패턴", emoji: "🏁", accent: "#EFEEEC", image: "/cards/bizcheck.png", badge: "NEW", tags: ["비즈니스"], go: "bizcheck" },
      { id: "bizknitdress", title: "카멜 니트 원피스 프로필", subtitle: "따뜻하면서 단정한 무드", emoji: "🐫", accent: "#F3EDE2", image: "/cards/bizknitdress.png", badge: "NEW", tags: ["비즈니스"], go: "bizknitdress" },
      { id: "idblack", title: "블랙 정장 증명사진", subtitle: "취업·이력서용 정석", emoji: "🖤", accent: "#EFEFF1", image: "/cards/idblack.png", badge: "NEW", tags: ["증명사진"], go: "idblack" },
      { id: "idnavy", title: "네이비 정장 증명사진", subtitle: "신뢰감 주는 면접용", emoji: "💙", accent: "#EAEFF7", image: "/cards/idnavy.png", badge: "NEW", tags: ["증명사진"], go: "idnavy" },
      { id: "idcharcoal", title: "차콜그레이 정장 증명사진", subtitle: "차분하고 전문적인", emoji: "🩶", accent: "#ECEDEF", image: "/cards/idcharcoal.png", badge: "NEW", tags: ["증명사진"], go: "idcharcoal" },
      { id: "idwhiteshirt", title: "화이트셔츠 증명사진", subtitle: "깔끔한 학생·사원증", emoji: "🤍", accent: "#F4F5F7", image: "/cards/idwhiteshirt.png", badge: "NEW", tags: ["증명사진"], go: "idwhiteshirt" },
      { id: "idbeige", title: "베이지 정장 증명사진", subtitle: "부드럽고 따뜻한 인상", emoji: "🧸", accent: "#F3ECE3", image: "/cards/idbeige.png", badge: "NEW", tags: ["증명사진"], go: "idbeige" },
      { id: "idblacktie", title: "블랙정장+넥타이 증명사진", subtitle: "격식 갖춘 면접·서류", emoji: "🤵", accent: "#EDEDEF", image: "/cards/idblacktie.png", badge: "NEW", tags: ["증명사진"], go: "idblacktie" },
      { id: "idblouse", title: "아이보리 블라우스 증명사진", subtitle: "편안하고 단정한", emoji: "🤍", accent: "#FBF3E8", image: "/cards/idblouse.png", badge : "NEW", tags: ["증명사진"], go: "idblouse" },
      { id: "idknit", title: "니트 가디건 증명사진", subtitle: "부드럽고 친근한", emoji: "🧶", accent: "#F5EFE6", image: "/cards/idknit.png", badge: "NEW", tags: ["증명사진"], go: "idknit" },
      { id: "idturtleneck", title: "터틀넥 증명사진", subtitle: "모던하고 미니멀한", emoji: "🖤", accent: "#EBECEE", image: "/cards/idturtleneck.png", badge: "NEW", tags: ["증명사진"], go: "idturtleneck" },
      { id: "idglasses", title: "정장+안경 증명사진", subtitle: "안경을 깔끔하게", emoji: "👓", accent: "#ECEEF1", image: "/cards/idglasses.png", badge: "NEW", tags: ["증명사진"], go: "idglasses" },
      { id: "idoffshoulder", title: "단발 오프숄더 증명사진", subtitle: "청초하고 자연스러운", emoji: "💜", accent: "#F0EBF7", image: "/cards/idoffshoulder.png", badge: "NEW", tags: ["증명사진"], go: "idoffshoulder" },
      { id: "idupdo", title: "올림머리 블라우스 증명사진", subtitle: "정돈된 이미지를 주는", emoji: "🤍", accent: "#EAF2EC", image: "/cards/idupdo.png", badge: "NEW", tags: ["증명사진"], go: "idupdo" },
      { id: "idlonghair", title: "긴머리 블라우스 증명사진", subtitle: "우아하고 자연스러운", emoji: "🌸", accent: "#F7ECF0", image: "/cards/idlonghair.png", badge: "NEW", tags: ["증명사진"], go: "idlonghair" },
      { id: "idtweed", title: "반묶음 트위드 증명사진", subtitle: "포멀한 러블리 무드", emoji: "🎀", accent: "#F9EEE8", image: "/cards/idtweed.png", badge: "NEW", tags: ["증명사진"], go: "idtweed" },
      { id: "idwavebob", title: "물결 단발 증명사진", subtitle: "발랄하고 상큼한 C컬", emoji: "💛", accent: "#F7F3E4", image: "/cards/idwavebob.png", badge: "NEW", tags: ["증명사진"], go: "idwavebob" },
      { id: "idponytail", title: "로우 포니테일 증명사진", subtitle: "깔끔하고 프로페셔널한", emoji: "💙", accent: "#ECEFF4", image: "/cards/idponytail.png", badge: "NEW", tags: ["증명사진"], go: "idponytail" },
      { id: "idgarma", title: "가르마컷 블랙정장 증명사진", subtitle: "신뢰감 있는 첫인상", emoji: "🖤", accent: "#ECEDEF", image: "/cards/idgarma.png", badge: "NEW", tags: ["증명사진"], go: "idgarma" },
      { id: "iddropcut", title: "드랍컷 블루셔츠 증명사진", subtitle: "차분한 리더의 이미지", emoji: "💙", accent: "#EAEFF7", image: "/cards/iddropcut.png", badge: "NEW", tags: ["증명사진"], go: "iddropcut" },
      { id: "idperm", title: "페릭컷 화이트티 증명사진", subtitle: "기본에 충실한 산뜻함", emoji: "🤍", accent: "#F5F1EA", image: "/cards/idperm.png", badge: "NEW", tags: ["증명사진"], go: "idperm" },
      { id: "idpomade", title: "포마드 레트로정장 증명사진", subtitle: "그 시절 감성의 클래식", emoji: "🕶️", accent: "#F0EBE4", image: "/cards/idpomade.png", badge: "NEW", tags: ["증명사진"], go: "idpomade" },
      { id: "idwarmbob", title: "웜브라운 단발 증명사진", subtitle: "따뜻하고 포근한 무드", emoji: "🤎", accent: "#F5EEE4", image: "/cards/idwarmbob.png", badge: "NEW", tags: ["증명사진"], go: "idwarmbob" },
      { id: "idhime", title: "밀크브라운 히메컷 증명사진", subtitle: "러블리하고 부드러운", emoji: "🎀", accent: "#F7ECEA", image: "/cards/idhime.png", badge: "NEW", tags: ["증명사진"], go: "idhime" },
      { id: "idashwave", title: "애쉬 웨이브 증명사진", subtitle: "세련되고 몽환적인", emoji: "🩶", accent: "#EEEEF0", image: "/cards/idashwave.png", badge: "NEW", tags: ["증명사진"], go: "idashwave" },
      { id: "idlowbun", title: "로우번 터틀넥 증명사진", subtitle: "시크하고 세련된 무드", emoji: "🖤", accent: "#F5EBEA", image: "/cards/idlowbun.png", badge: "NEW", tags: ["증명사진"], go: "idlowbun" },
      { id: "idburgundy", title: "버건디 오프숄더 프로필", subtitle: "우아하고 여성스러운 화보", emoji: "🍷", accent: "#F6E9E6", image: "/cards/idburgundy.png", badge: "NEW", tags: ["증명사진"], go: "idburgundy" },
      { id: "iddandy", title: "댄디 베스트 증명사진", subtitle: "시원하고 댄디한 무드", emoji: "🩵", accent: "#EAEFF4", image: "/cards/iddandy.png", badge: "NEW", tags: ["증명사진"], go: "iddandy" },
      { id: "iddownperm", title: "다운펌 화이트셔츠 증명사진", subtitle: "청량하고 산뜻한 첫인상", emoji: "🩵", accent: "#EAF3FB", image: "/cards/iddownperm.png", badge: "NEW", tags: ["증명사진"], go: "iddownperm" },
      { id: "idnavysuit", title: "가르마 네이비수트 증명사진", subtitle: "신뢰감 있는 프로페셔널", emoji: "💙", accent: "#EAEFF7", image: "/cards/idnavysuit.png", badge: "NEW", tags: ["증명사진"], go: "idnavysuit" },
      { id: "idbeigeblazer", title: "소프트펌 베이지 증명사진", subtitle: "세련되고 따뜻한 무드", emoji: "🤎", accent: "#F3ECE3", image: "/cards/idbeigeblazer.png", badge: "NEW", tags: ["증명사진"], go: "idbeigeblazer" },
      { id: "idhenley", title: "투블럭 헨리넥 증명사진", subtitle: "감각적이고 모던한", emoji: "🌿", accent: "#ECEFEA", image: "/cards/idhenley.png", badge: "NEW", tags: ["증명사진"], go: "idhenley" },
      ...
      { id: "wedding", title: "웨딩 화보", subtitle: "드레스·턱시도 입은 나", emoji: "💍", accent: "#FFE0EC", badge: "NEW", tags: ["웨딩"], image: "/cards/wedding.png", go: "wedding" },
      { id: "petstudio", title: "펫 스튜디오 화보", subtitle: "우리 애기 화보 찍는 날", emoji: "🐶", accent: "#FFF1E0", badge: "NEW", tags: ["반려동물"], image: "/cards/petstudio.png", go: "petstudio" },
          ...
          <div style={{ position: "fixed", inset: 0, background: "#fff", zIndex: 130, display: "flex", flexDirection: "column", maxWidth: 480, margin: "0 auto" }}>
            ...
            <div style={{ padding: "12px 16px 22px", background: "#fff", boxShadow: "0 -4px 20px rgba(0,0,0,0.05)", flexShrink: 0 }}>
              {detail.start === "soon" ? (
                ...
                <button onClick={() => { setDetail(null); if (detail.start === "baby") { setActiveTab("home"); setShowMakeScreen(true); } else if (detail.start === "idphoto") { window.location.href = "/id-photo"; } else if (detail.start === "voxel") { window.location.href = "/voxel"; } else if (detail.start === "food") { window.location.href = "/food"; } else if (detail.start === "factory") { window.location.href = "/factory"; } else if (detail.start === "pet") { window.location.href = "/pet"; } else if (detail.start === "product") { window.location.href = "/product"; } else if (detail.start === "restore") { window.location.href = "/restore"; } else if (detail.start === "realestate") { window.location.href = "/realestate"; } else if (detail.start === "interior") { window.location.href = "/interior"; } else if (detail.start === "car") { window.location.href = "/car"; } else if (detail.start === "lifeshot") { window.location.href = "/lifeshot"; } else if (detail.start === "bizprofile") { window.location.href = "/bizprofile"; } else if (detail.start === "hairstyle") { window.location.href = "/hairstyle"; } else if (detail.start === "illust") { window.location.href = "/illust"; } else if (detail.start === "idskyblue") { window.location.href = "/id-skyblue-skyblue"; } else if (detail.start === "biznavy") { window.location.href = "/biz-navy-gray"; } else if (detail.start === "bizmnavy") { window.location.href = "/biz-man-navy"; } else if (detail.start === "bizmcharcoal") { window.location.href = "/biz-man-charcoal"; } else if (detail.start === "bizmblack") { window.location.href = "/biz-man-black"; } else if (detail.start === "bizmlightgray") { window.location.href = "/biz-man-lightgray"; } else if (detail.start === "bizmvest") { window.location.href = "/biz-man-vest"; } else if (detail.start === "bizmbeige") { window.location.href = "/biz-man-beige"; } else if (detail.start === "bizmblazer") { window.location.href = "/biz-man-blazer"; } else if (detail.start === "bizmturtle") { window.location.href = "/biz-man-turtleneck"; } else if (detail.start === "bizmdb") { window.location.href = "/biz-man-db"; } else if (detail.start === "bizmknittie") { window.location.href = "/biz-man-knittie"; } else if (detail.start === "bizblack") { window.location.href = "/biz-black-gray"; } else if (detail.start === "bizwhite") { window.location.href = "/biz-white-gray"; } else if (detail.start === "bizribbon") { window.location.href = "/biz-ribbon-gray"; } else if (detail.start === "bizbeige") { window.location.href = "/biz-beige-gray"; } else if (detail.start === "bizlavender") { window.location.href = "/biz-lavender-gray"; } else if (detail.start === "bizgray") { window.location.href = "/biz-gray-gray"; } else if (detail.start === "bizknit") { window.location.href = "/biz-knit-gray"; } else if (detail.start === "bizchiffon") { window.location.href = "/biz-chiffon-gray"; } else if (detail.start === "bizpinkjacket") { window.location.href = "/biz-pinkjacket-gray"; } else if (detail.start === "bizcreamdress") { window.location.href = "/biz-creamdress-gray"; } else if (detail.start === "biznavyblouse") { window.location.href = "/biz-navyblouse-gray"; } else if (detail.start === "bizskyblouse") { window.location.href = "/biz-skyblouse-gray"; } else if (detail.start === "bizpinktweed") { window.location.href = "/biz-pinktweed-gray"; } else if (detail.start === "bizshirring") { window.location.href = "/biz-shirring-gray"; } else if (detail.start === "bizviolet") { window.location.href = "/biz-violet-gray"; } else if (detail.start === "bizblueskirt") { window.location.href = "/biz-blueskirt-gray"; } else if (detail.start === "bizburgundy") { window.location.href = "/biz-burgundy-gray"; } else if (detail.start === "bizkhaki") { window.location.href = "/biz-khaki-gray"; } else if (detail.start === "bizblackdress") { window.location.href = "/biz-blackdress-gray"; } else if (detail.start === "bizbluegray") { window.location.href = "/biz-bluegray-gray"; } else if (detail.start === "bizpinstripe") { window.location.href = "/biz-pinstripe-gray"; } else if (detail.start === "bizcheck") { window.location.href = "/biz-check-gray"; } else if (detail.start === "bizknitdress") { window.location.href = "/biz-knitdress-gray"; } else if (detail.start === "idblack") { window.location.href = "/id-black-gray"; } else if (detail.start === "idnavy") { window.location.href = "/id-navy-gray"; } else if (detail.start === "idcharcoal") { window.location.href = "/id-charcoal-gray"; } else if (detail.start === "idwhiteshirt") { window.location.href = "/id-whiteshirt-gray"; } else if (detail.start === "idbeige") { window.location.href = "/id-beige-gray"; } else if (detail.start === "idblacktie") { window.location.href = "/id-blacktie-gray"; } else if (detail.start === "idblouse") { window.location.href = "/id-blouse-gray"; } else if (detail.start === "idknit") { window.location.href = "/id-knit-gray"; } else if (detail.start === "idturtleneck") { window.location.href = "/id-turtleneck-gray"; } else if (detail.start === "idglasses") { window.location.href = "/id-glasses-gray"; } else if (detail.start === "idoffshoulder") { window.location.href = "/id-offshoulder"; } else if (detail.start === "idupdo") { window.location.href = "/id-updo"; } else if (detail.start === "idlonghair") { window.location.href = "/id-longhair"; } else if (detail.start === "idtweed") { window.location.href = "/id-tweed"; } else if (detail.start === "idwavebob") { window.location.href = "/id-wavebob"; } else if (detail.start === "idponytail") { window.location.href = "/id-ponytail"; } else if (detail.start === "idgarma") { window.location.href = "/id-garma"; } else if (detail.start === "iddropcut") { window.location.href = "/id-dropcut"; } else if (detail.start === "idperm") { window.location.href = "/id-perm"; } else if (detail.start === "idpomade") { window.location.href = "/id-pomade"; } else if (detail.start === "idwarmbob") { window.location.href = "/id-warmbob"; } else if (detail.start === "idhime") { window.location.href = "/id-hime"; } else if (detail.start === "idashwave") { window.location.href = "/id-ashwave"; } else if (detail.start === "idlowbun") { window.location.href = "/id-lowbun"; } else if (detail.start === "idburgundy") { window.location.href = "/id-burgundy"; } else if (detail.start === "iddandy") { window.location.href = "/id-dandy"; } else if (detail.start === "iddownperm") { window.location.href = "/id-downperm"; } else if (detail.start === "idnavysuit") { window.location.href = "/id-navysuit"; } else if (detail.start === "idbeigeblazer") { window.location.href = "/id-beigeblazer"; } else if (detail.start === "idhenley") { window.location.href = "/id-henley"; } else if (detail.start === "figure") { window.location.href = "/figure"; } else if (detail.start === "age") { window.location.href = "/age"; }else if (detail.start === "menu") { window.location.href = "/menu"; } else if (detail.start === "nukki") { window.location.href = "/nukki"; } else if (detail.start === "upscale") { window.location.href = "/upscale"; } else if (detail.start === "fashion") { window.location.href = "/fashion"; } else if (detail.start === "idol") { window.location.href = "/idol"; }else if (detail.start === "xmas") { window.location.href = "/xmas"; } else if (detail.start === "graduation") { window.location.href = "/graduation"; } else if (detail.start === "wedding") { window.location.href = "/wedding"; }else if (detail.start === "petstudio") { window.location.href = "/petstudio"; } else if (detail.start === "petreceipt") { window.location.href = "/petreceipt"; }else if (detail.start === "era") { window.location.href = "/era"; } else if (detail.start === "petcostume") { window.location.href = "/petcostume"; }else if (detail.start === "couple") { window.location.href = "/couple"; } else if (detail.start === "hanbokcouple") { window.location.href = "/hanbokcouple"; } else if (detail.start === "friend") { window.location.href = "/friend"; }else if (detail.start === "family") { window.location.href = "/family"; } else if (detail.start === "familyhanbok") { window.location.href = "/familyhanbok"; } else if (detail.start === "familypet") { window.location.href = "/familypet"; }else if (detail.start === "fourcut") { window.location.href = "/fourcut"; } else if (detail.start === "fourcutillust") { window.location.href = "/fourcutillust"; } else if (detail.start === "fourcutcouple") { window.location.href = "/fourcutcouple"; }}} style={{ width: "100%", padding: "15px 0", borderRadius: 16, border: "none", background: "#FF4B7C", color: "#fff", fontSize: 16, fontWeight: 800, cursor: "pointer", boxShadow: "0 6px 18px rgba(255,75,124,0.3)", display: "flex", flexDirection: "column", gap: 2, alignItems: "center" }}>
                  <span>프로필 만들기</span>
