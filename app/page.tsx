...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "idoffshoulder", title: "단발 오프숄더 증명사진", subtitle: "청초하고 자연스러운", emoji: "💜", accent: "#F0EBF7", badge: "NEW", tags: ["증명사진"], go: "idoffshoulder" },
      { id: "idupdo", title: "올림머리 블라우스 증명사진", subtitle: "정돈된 이미지를 주는", emoji: "🤍", accent: "#EAF2EC", badge: "NEW", tags: ["증명사진"], go: "idupdo" },
      { id: "idlonghair", title: "긴머리 블라우스 증명사진", subtitle: "우아하고 자연스러운", emoji: "🌸", accent: "#F7ECF0", badge: "NEW", tags: ["증명사진"], go: "idlonghair" },
      { id: "idtweed", title: "반묶음 트위드 증명사진", subtitle: "포멀한 러블리 무드", emoji: "🎀", accent: "#F9EEE8", badge: "NEW", tags: ["증명사진"], go: "idtweed" },
      { id: "idwavebob", title: "물결 단발 증명사진", subtitle: "발랄하고 상큼한 C컬", emoji: "💛", accent: "#F7F3E4", badge: "NEW", tags: ["증명사진"], go: "idwavebob" },
      { id: "idponytail", title: "로우 포니테일 증명사진", subtitle: "깔끔하고 프로페셔널한", emoji: "💙", accent: "#ECEFF4", badge: "NEW", tags: ["증명사진"], go: "idponytail" },
      { id: "idgarma", title: "가르마컷 블랙정장 증명사진", subtitle: "신뢰감 있는 첫인상", emoji: "🖤", accent: "#ECEDEF", badge: "NEW", tags: ["증명사진"], go: "idgarma" },
      { id: "iddropcut", title: "드랍컷 블루셔츠 증명사진", subtitle: "차분한 리더의 이미지", emoji: "💙", accent: "#EAEFF7", badge: "NEW", tags: ["증명사진"], go: "iddropcut" },
      { id: "idperm", title: "페릭컷 화이트티 증명사진", subtitle: "기본에 충실한 산뜻함", emoji: "🤍", accent: "#F5F1EA", badge: "NEW", tags: ["증명사진"], go: "idperm" },
      { id: "idpomade", title: "포마드 레트로정장 증명사진", subtitle: "그 시절 감성의 클래식", emoji: "🕶️", accent: "#F0EBE4", badge: "NEW", tags: ["증명사진"], go: "idpomade" },
