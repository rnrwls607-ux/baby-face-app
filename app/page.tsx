...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "hanbok", title: "한복 화보", subtitle: "고궁 노을빛, 기품 있는 나", emoji: "🌸", accent: "#FCE8EF", badge: "NEW", tags: ["인생샷"], go: "hanbok" },
      { id: "retro90", title: "90년대 사진관", subtitle: "그때 그 사진관 감성", emoji: "📼", accent: "#FFEFD6", badge: "NEW", tags: ["재미"], go: "retro90" },
      { id: "hocance", title: "호캉스 화보", subtitle: "5성급 풀사이드 바이브", emoji: "🏝️", accent: "#DCEBFF", badge: "NEW", tags: ["인생샷"], go: "hocance" },
      { id: "redcarpet", title: "레드카펫 화보", subtitle: "오늘 밤의 주인공", emoji: "✨", accent: "#E8EAED", badge: "NEW", tags: ["인생샷"], go: "redcarpet" },
      { id: "birthday", title: "생일 화보", subtitle: "일 년 중 가장 빛나는 날", emoji: "🎂", accent: "#FFE0EC", badge: "NEW", tags: ["인생샷"], go: "birthday" },
      { id: "job", title: "직업 변신", subtitle: "파일럿·의사·CEO로 변신", emoji: "💼", accent: "#EFEAFF", badge: "NEW", tags: ["재미"], go: "job" },
      { id: "sporty", title: "스포티 화보", subtitle: "테니스·골프 올드머니 룩", emoji: "🎾", accent: "#E7F7EA", badge: "NEW", tags: ["인생샷"], go: "sporty" },
      { id: "flower", title: "플라워 화보", subtitle: "꽃에 둘러싸인 순간", emoji: "💐", accent: "#FCE8EF", badge: "NEW", tags: ["인생샷"], go: "flower" },
