...
const HOME_SECTIONS: { id: string; heading: string; title: string; layout: string; items: HomeCardItem[]; cat?: string }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // ★상세·썸네일 나올 때까지 잠금 — 자산 준비되면 이 줄의 // 만 지운다
      { id: "bouquetshot", title: "꽃다발 상품컷", subtitle: "꽃집 대표컷, 작업대에서 바로", emoji: "💐", accent: "#C4707E", image: "/cards/bouquetshot.webp", badge: "NEW", tags: ["상품"], go: "bouquetshot" },
      // ★상세·썸네일 나올 때까지 잠금 — 자산 준비되면 이 줄의 // 만 지운다
      ...
      // ★상세·썸네일 나올 때까지 잠금 — 자산 준비되면 이 줄의 // 만 지운다
      { id: "foodsketch", title: "음식만 스케치", subtitle: "사진은 실사, 음식만 그림으로", emoji: "🍣", accent: "#6C8E4E", image: "/cards/foodsketch.webp", badge: "NEW", tags: ["음식"], go: "foodsketch" },
      // ★상세·썸네일 나올 때까지 잠금 — 자산 준비되면 이 줄의 // 만 지운다
      { id: "product360", title: "제품 4뷰 시트", subtitle: "앞·옆·뒤·위, 한 장에", emoji: "🔄", accent: "#3F5E8C", image: "/cards/product360.webp", badge: "NEW", tags: ["상품"], go: "product360" },
      // ★상세·썸네일 나올 때까지 잠금 — 자산 준비되면 이 줄의 // 만 지운다
      { id: "petbouquet", title: "꽃다발 속 우리 아이", subtitle: "꽃다발이 되어 돌아온 우리 아이", emoji: "💐", accent: "#D97A8C", image: "/cards/petbouquet.webp", badge: "NEW", tags: ["반려동물"], go: "petbouquet" },
      // ★상세·썸네일 나올 때까지 잠금 — 자산 준비되면 이 줄의 // 만 지운다
