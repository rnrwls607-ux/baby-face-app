...
export default function IdNavyGrayPage() {
  ...
  const handleDownload = (url: string, idx: number) => {
    ...
    a.download = `id-navy-gray-${idx + 1}.png`;
    ...
    <div style={{ maxWidth: 480, margin: "0 auto", minHeight: "100vh", background: "#F7F8FA", fontFamily: "var(--font-noto), 'Apple SD Gothic Neo', sans-serif" }}>
      ...
      <div style={{ padding: "18px 18px 100px" }}>
        <div style={{ background: "#FFF0F5", borderRadius: 16, padding: "16px 18px", marginBottom: 22 }}>
          <p style={{ fontSize: 14, fontWeight: 800, color: ACCENT, margin: "0 0 5px" }}>💙 네이비 정장 증명사진</p>
          <p style={{ fontSize: 12.5, color: "#7A6A70", margin: 0, lineHeight: 1.55 }}>신뢰감 있는 네이비 정장과 밝은 회색 배경의 단정한 증명사진이에요. 얼굴이 정면으로 잘 보이는 사진을 3~6장 올리면, 가장 잘 나온 증명사진 3장을 만들어드려요. (남녀 모두 사용할 수 있어요.)</p>
        </div>
