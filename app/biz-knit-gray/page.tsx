...
export default function BizKnitGrayPage() {
  ...
  const handleDownload = (url: string, idx: number) => {
    ...
    a.download = `biz-knit-gray-${idx + 1}.png`;
    ...
    <div style={{ maxWidth: 480, margin: "0 auto", minHeight: "100vh", background: "#F7F8FA", fontFamily: "var(--font-noto), 'Apple SD Gothic Neo', sans-serif" }}>
      ...
      <div style={{ padding: "18px 18px 100px" }}>
        <div style={{ background: "#FFF0F5", borderRadius: 16, padding: "16px 18px", marginBottom: 22 }}>
          <p style={{ fontSize: 14, fontWeight: 800, color: ACCENT, margin: "0 0 5px" }}>🧶 부드러운 니트 가디건</p>
          <p style={{ fontSize: 12.5, color: "#7A6A70", margin: 0, lineHeight: 1.55 }}>부드러운 니트 가디건과 깔끔한 블라우스, 밝은 회색 배경의 친근한 여성 전문가 프로필이에요. 정면 사진 3~6장을 올리면, 팔짱·손모음·자연스러운 각도까지 서로 다른 포즈의 프로필 3장을 만들어드려요. (여성 전용 컨셉이에요.)</p>
        </div>
