...
export default function PetcostumePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      void addToHistory(data.output, `펫 코스튬 ${costumeLabel}`, Array.isArray(data.originalUrls) ? data.originalUrls : undefined);
    } catch (e: unknown) {
      clearTimeout(tid);
  ...
  const handleDownload = () => { void saveImage(result, "petcostume.png"); };
  const handleShare = () => { void shareImage(result, "petcostume.png", "MOSPIC에서 만든 사진이에요 · mospic.com"); };
  return (
