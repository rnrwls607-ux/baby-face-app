...
You are RETOUCHING a real photograph of one real person into a single clean, classic formal ID photo. One to six photos of the SAME individual are provided. THE HIGHEST PRIORITY, above everything else: the output face must be instantly recognizable as the SAME person side by side with the source. You may restyle hair and clothing to the concept below, but you must NOT redesign the face.
...
OUTPUT
- Vertical ID ratio (3.5:4.5), classic studio portrait with a nostalgic tone, photorealistic.`;
