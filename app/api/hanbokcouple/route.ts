...
- The mood: a breathtaking traditional Korean wedding pictorial — a couple in exquisite wedding hanbok, romantic and regal.
- WARDROBE: magnificent wedding-grade hanbok appropriate to each person's confirmed gender — for a female person, a luminous bridal hanbok with delicate embroidery and graceful flowing lines, optionally a fine traditional hair ornament worn so it never shadows the face; for a male person, a dignified groom's hanbok with an elegant silk overcoat in deep tasteful tones. The two hanbok in DIFFERENT harmonizing festive colors — glowing silks, tasteful and regal, never costume-cheap. Crisp collars, clean goreum, no tangled fabric.
- HAIR RULE: a female person — soft romantic styling with at most a delicate ornament, NEVER a severe pulled-back updo; a male person — neat handsome hair, nothing shadowing the face.
