...
export const CONCEPTS: Record<string, Concept> = {
  ...
  personalcolor: {
    ...
    coinCost: 3,
    title: "퍼스널컬러 화보",
    subtitle: "내게 꼭 맞는 색을 입다",
    emoji: "🎨",
    accent: "#D98BA3",
    description: "얼굴빛에 가장 잘 어울리는 색을 골라 그 색으로 꾸민 퍼스널컬러 화보를 만들어드려요. 옷과 배경이 하나의 색 이야기로 맞아떨어져요.",
    examples: [
      { emoji: "🎨", accent: "#D98BA3" },
      { emoji: "🌷", accent: "#FFE0EC" },
      { emoji: "🧣", accent: "#E1ECFF" },
  ...
  monoactor: {
    key: "monoactor", audience: "all",
    coinCost: 3,
    title: "흑백 배우 프로필",
    subtitle: "흑백이 말해주는 분위기",
    emoji: "🎞️",
    accent: "#3A3D42",
    description: "캐스팅 디렉터가 보는 배우 프로필처럼, 깊은 흑백 톤의 인물 사진으로 만들어드려요. 색이 빠지니 분위기가 남아요.",
    examples: [
      { emoji: "🎞️", accent: "#3A3D42" },
      { emoji: "🖤", accent: "#E3E7EE" },
      { emoji: "🎬", accent: "#EFEAFF" },
    ],
    start: "monoactor",
  ...
  fortunecard: {
    key: "fortunecard", audience: "all",
    coinCost: 3,
    title: "관상 화보",
    subtitle: "복이 가득한 얼굴",
    emoji: "🏮",
    accent: "#A63A2E",
    description: "복이 깃든 얼굴이라는 뜻의 동양풍 관상 화보로 만들어드려요. 한지와 금빛 가루가 어우러진 고급스러운 한 컷. 재미로 즐기는 컨셉이에요.",
    examples: [
      { emoji: "🏮", accent: "#A63A2E" },
      { emoji: "🀄", accent: "#FFEFD6" },
      { emoji: "🌸", accent: "#FFE0EC" },
  ...
  minichef: {
    key: "minichef", audience: "all",
    coinCost: 3,
    title: "미니 셰프 푸드샷",
    subtitle: "내 요리 위 꼬마 셰프",
    emoji: "🍳",
    accent: "#E67E22",
    description: "음식 사진을 광고컷처럼 맛있게 다듬고, 그 위에 손가락만 한 꼬마 셰프를 불러드려요. 허브를 뿌리고 소스를 붓는 판타지 푸드샷.",
    examples: [
      { emoji: "🍳", accent: "#E67E22" },
      { emoji: "🧑‍🍳", accent: "#FFEFD6" },
      { emoji: "🌿", accent: "#E7F7EA" },
  ...
  poolside: {
    ...
    emoji: "🏖️",
    accent: "#2E9CB8",
    description: "리조트 인피니티 풀에서 찍은 듯한 풀사이드 화보로 만들어드려요. 물빛과 햇살은 배경으로 두고, 얼굴은 가장 환하게.",
    examples: [
      { emoji: "🏖️", accent: "#2E9CB8" },
      { emoji: "🌴", accent: "#E7F7EA" },
      { emoji: "🍹", accent: "#FFEFD6" },
    ],
    start: "poolside",
  ...
  snowsnap: {
    key: "snowsnap", audience: "all",
    coinCost: 3,
    title: "첫눈 스냅",
    subtitle: "첫눈처럼 설레는",
    emoji: "❄️",
    accent: "#7FA8C9",
    description: "함박눈이 내리는 겨울 스냅으로 만들어드려요. 눈송이는 흩날려도 얼굴은 창백해지지 않게, 따뜻하고 화사하게.",
    examples: [
      { emoji: "❄️", accent: "#7FA8C9" },
      { emoji: "🧣", accent: "#E1ECFF" },
      { emoji: "🌨️", accent: "#EFEAFF" },
    ],
    start: "snowsnap",
  ...
  profileduo: {
    key: "profileduo", audience: "all",
    coinCost: 3,
    title: "베프 프로필 스냅",
    subtitle: "우리 둘, 나란히",
    emoji: "👯",
    accent: "#E8A0B4",
    description: "각자 찍은 사진 두 장을 나란히 선 듯한 베프 프로필 한 장으로 만들어드려요. 두 얼굴은 절대 섞이지 않아요.",
    examples: [
      { emoji: "👯", accent: "#E8A0B4" },
      { emoji: "💛", accent: "#FFEFD6" },
      { emoji: "📸", accent: "#E1ECFF" },
  ...
  droneview: {
    key: "droneview", audience: "all",
    coinCost: 3,
    title: "드론뷰 여행샷",
    subtitle: "드론 없이 드론샷",
    emoji: "🚁",
    accent: "#3A8FB7",
    description: "여행 사진 한 장이 하늘에서 찍은 인생샷으로",
    examples: [
      { emoji: "🚁", accent: "#3A8FB7" },
    ],
    start: "droneview",
    detailImage: "/details/droneview.webp",
    inputRule: "solo_face",
  },
  autumnsnap: {
    key: "autumnsnap", audience: "all",
    coinCost: 3,
    title: "단풍 스냅",
    subtitle: "가장 예쁜 계절, 가장 예쁜 나",
    emoji: "🍁",
    accent: "#C8763A",
    description: "노랗게 물든 은행나무 길에서 찍은 듯한 가을 스냅으로 만들어드려요. 단풍은 배경으로 두고, 얼굴은 가장 화사하게.",
    examples: [
      { emoji: "🍁", accent: "#C8763A" },
    ],
    start: "autumnsnap",
    detailImage: "/details/autumnsnap.webp",
    inputRule: "solo_face",
  },
  trenchlook: {
    key: "trenchlook", audience: "all",
    coinCost: 3,
    title: "트렌치코트 가을 화보",
    subtitle: "걷다 멈춘, 그 한 컷",
    emoji: "🧥",
    accent: "#8B6B4E",
    description: "낙엽 진 도심 거리에서 트렌치코트 차림으로 걷다 멈춘 듯한 화보로 만들어드려요. 포즈를 잡은 사진이 아니라, 지나가다 찍힌 한 컷처럼.",
    examples: [
      { emoji: "🧥", accent: "#8B6B4E" },
    ],
    start: "trenchlook",
  ...
  examcheer: {
    key: "examcheer", audience: "all",
    coinCost: 3,
    title: "수능 응원 스냅",
    subtitle: "잘 될 거야, 라는 한 장",
    emoji: "🌸",
    accent: "#D94F4F",
    description: "꽃다발과 리본이 있는 따뜻한 스튜디오에서 찍은 응원 스냅으로 만들어드려요. 든든하고 환한 표정으로, 마음을 전하는 한 장.",
    examples: [
      { emoji: "🌸", accent: "#D94F4F" },
    ],
    start: "examcheer",
    detailImage: "/details/examcheer.webp",
    inputRule: "solo_face",
  },
  xmasvintage: {
    key: "xmasvintage", audience: "all",
    coinCost: 3,
    title: "빈티지 크리스마스 스냅",
    subtitle: "필름에 담긴 연말 저녁",
    emoji: "🎁",
    accent: "#8B2E2E",
    description: "트리 불빛이 보케로 번지는 집 안 거실에서, 필름 카메라로 찍은 듯한 빈티지 크리스마스 스냅으로 만들어드려요. 스튜디오 세트가 아니라, 진짜 연말 저녁의 한 장처럼.",
    examples: [
      { emoji: "🎁", accent: "#8B2E2E" },
    ],
    start: "xmasvintage",
    detailImage: "/details/xmasvintage.webp",
    inputRule: "solo_face",
  },
  campsnap: {
    key: "campsnap", audience: "all",
    coinCost: 3,
    title: "감성 캠핑 스냅",
    subtitle: "랜턴 불빛 아래, 그 저녁",
    emoji: "🏕️",
    accent: "#4A6B4F",
    description: "블루아워 캠핑장에서 랜턴과 모닥불을 배경으로 찍은 감성 캠핑 스냅으로 만들어드려요. 불빛은 뒤에 두고, 얼굴은 깨끗하게.",
    examples: [
      { emoji: "🏕️", accent: "#4A6B4F" },
    ],
    start: "campsnap",
    detailImage: "/details/campsnap.webp",
    inputRule: "solo_face",
  },
  picnicsnap: {
    key: "picnicsnap", audience: "all",
    coinCost: 3,
    title: "한강 피크닉 스냅",
    subtitle: "맑은 날, 잔디 위 한 장",
    emoji: "🧺",
    accent: "#6BA36B",
    description: "맑은 대낮 강변 잔디밭에 돗자리 펴고 찍은 듯한 피크닉 스냅으로 만들어드려요. 과일 바구니와 자전거까지, 딱 좋은 날의 한 컷.",
    examples: [
      { emoji: "🧺", accent: "#6BA36B" },
    ],
    start: "picnicsnap",
  ...
  partysnap: {
    ...
    start: "partysnap",
    detailImage: "/details/partysnap.webp",
    inputRule: "solo_face",
  },
  skisnap: {
    key: "skisnap", audience: "all",
    coinCost: 3,
    title: "스키장 겨울 스냅",
    subtitle: "설산 위, 겨울 인생샷",
    emoji: "⛷️",
    accent: "#3B7DD8",
    description: "패딩·스키웨어에 고글은 이마 위로. 눈부신 설산 배경에서도 얼굴은 밝고 선명한 스키장 화보로 바꿔드려요.",
    examples: [
      { emoji: "⛷️", accent: "#3B7DD8" },
    ],
    start: "skisnap",
    detailImage: "/details/skisnap.webp",
    inputRule: "solo_face",
  },
  productscene: {
    key: "productscene", audience: "all",
    coinCost: 3,
    title: "제품 연출컷",
    subtitle: "상세페이지 연출컷, 사진 한 장으로",
    emoji: "🪴",
    accent: "#6B8E5A",
    description: "대충 찍은 제품 사진을 원목 테이블·리넨·창가 빛 위에 놓인 라이프스타일 연출컷으로. 라벨·글자·색·형태는 그대로.",
    examples: [
      { emoji: "🪴", accent: "#6B8E5A" },
    ],
    start: "productscene",
    detailImage: "/details/productscene.webp",
  },
  kidsdraw: {
    key: "kidsdraw", audience: "all",
    coinCost: 3,
    title: "아이 그림 실사화",
    subtitle: "우리 아이 그림이 진짜가 됐어요",
    emoji: "🖍️",
    accent: "#E8743B",
    description: "아이가 그린 크레파스 그림을 형태·색·엉뚱한 비율 그대로 살린 실사 사진으로. 액자·선물·가족 단톡 자랑용.",
    examples: [
      { emoji: "🖍️", accent: "#E8743B" },
    ],
    start: "kidsdraw",
    detailImage: "/details/kidsdraw.webp",
  },
  flatlay: {
    key: "flatlay", audience: "all",
    coinCost: 3,
    title: "플랫레이 상품컷",
    subtitle: "위에서 찍은 정돈된 한 컷",
    emoji: "🧺",
    accent: "#8C7A6B",
    description: "널브러진 여러 제품을 깔끔하게 배치된 플랫레이 상품컷으로. 각 제품은 그대로, 배치·배경·그림자만 정리.",
    examples: [
      { emoji: "🧺", accent: "#8C7A6B" },
    ],
    start: "flatlay",
    detailImage: "/details/flatlay.webp",
  },
  ghostfit: {
    key: "ghostfit", audience: "all",
    coinCost: 3,
    title: "고스트 마네킹 착장컷",
    subtitle: "마네킹 없이, 입은 것처럼",
    emoji: "👕",
    accent: "#4F6D8F",
    description: "옷걸이·바닥에 놓인 옷 한 벌을 보이지 않는 마네킹이 입은 입체 착장컷으로. 원단·패턴·라벨은 그대로.",
    examples: [
      { emoji: "👕", accent: "#4F6D8F" },
    ],
    start: "ghostfit",
    detailImage: "/details/ghostfit.webp",
  },
  carad: {
    key: "carad", audience: "all",
    coinCost: 3,
    title: "자동차 광고컷",
    subtitle: "내 차가 카탈로그 표지처럼",
    emoji: "🏎️",
    accent: "#2E3A4F",
    description: "주차장에서 찍은 내 차를 해안도로·산길·스튜디오 배경의 광고 카탈로그 컷으로. 차체·색·휠은 그대로, 번호판은 빈 판.",
    examples: [
      { emoji: "🏎️", accent: "#2E3A4F" },
    ],
    start: "carad",
    detailImage: "/details/carad.webp",
  },
  sketch2real: {
    key: "sketch2real", audience: "all",
    coinCost: 3,
    title: "스케치 실물화",
    subtitle: "종이 위 아이디어를 실물로",
    emoji: "✏️",
    accent: "#5A5A6E",
    description: "가방·의자·신발·소품 손 스케치를 그 형태 그대로 실물 제품 사진으로. 펀딩·시안·발표용.",
    examples: [
      { emoji: "✏️", accent: "#5A5A6E" },
    ],
    start: "sketch2real",
    detailImage: "/details/sketch2real.webp",
  },
  nailshot: {
    key: "nailshot", audience: "all",
    coinCost: 3,
    title: "네일아트 상품컷",
    subtitle: "네일샵 인스타 표준컷",
    emoji: "💅",
    accent: "#C96A8A",
    description: "손님 손 대충 찍은 네일 사진을 네일샵 인스타 대표컷으로. 손·디자인·컬러·파츠는 그대로, 배경·조명·정돈만.",
    examples: [
      { emoji: "💅", accent: "#C96A8A" },
    ],
    start: "nailshot",
  ...
  bouquetshot: {
    key: "bouquetshot", audience: "all",
    coinCost: 3,
    title: "꽃다발 상품컷",
    subtitle: "꽃집 대표컷, 작업대에서 바로",
    emoji: "💐",
    accent: "#C4707E",
    description: "작업대에서 찍은 꽃다발을 꽃집 인스타·예약 대표컷으로. 꽃 종류·개수·포장·리본은 그대로, 배경·빛만 교체.",
    examples: [
      { emoji: "💐", accent: "#C4707E" },
    ],
    start: "bouquetshot",
    detailImage: "/details/bouquetshot.webp",
  },
  plantshot: {
    key: "plantshot", audience: "all",
    coinCost: 3,
    title: "반려식물 화보",
    subtitle: "우리 집 식물, 화보로",
    emoji: "🪴",
    accent: "#4E7D4F",
    description: "창가 화분을 식집사 감성 화보로. 잎 모양·개수·무늬·화분은 그대로, 빛·배경·구도만 스튜디오급.",
    examples: [
      { emoji: "🪴", accent: "#4E7D4F" },
    ],
    start: "plantshot",
    detailImage: "/details/plantshot.webp",
  },
  fooddoodle: {
    key: "fooddoodle", audience: "all",
    coinCost: 3,
    title: "음식 캐릭터 낙서",
    subtitle: "음식이 살아 움직이는 피드",
    emoji: "🍰",
    accent: "#F28C6B",
    description: "음식 사진 속 디저트·메뉴에 귀여운 얼굴과 팔다리를 붙이고 하트·별 손낙서로 꾸며드려요. 사진은 그대로, 낙서만 추가.",
    examples: [
      { emoji: "🍰", accent: "#F28C6B" },
    ],
    start: "fooddoodle",
    detailImage: "/details/fooddoodle.webp",
  },
  foodsketch: {
    key: "foodsketch", audience: "all",
    coinCost: 3,
    title: "음식만 스케치",
    subtitle: "사진은 실사, 음식만 그림으로",
    emoji: "🍣",
    accent: "#6C8E4E",
    description: "사진 속 음식·음료·식기만 색연필 스케치로 바꿔드려요. 사람과 배경은 실사 그대로 — 얼굴 보정 없음.",
    examples: [
      { emoji: "🍣", accent: "#6C8E4E" },
    ],
    start: "foodsketch",
  ...
  product360: {
    key: "product360", audience: "all",
    coinCost: 3,
    title: "제품 4뷰 시트",
    subtitle: "앞·옆·뒤·위, 한 장에",
    emoji: "🔄",
    accent: "#3F5E8C",
    description: "제품 사진 1장을 앞·옆·뒤·위 4면 뷰 시트로. 상세페이지 스펙컷·제작 의뢰용. 라벨·색·형태는 그대로, 안 보이는 면은 글자 없이.",
    examples: [
      { emoji: "🔄", accent: "#3F5E8C" },
    ],
    start: "product360",
  ...
  petbouquet: {
    ...
    start: "petbouquet",
    detailImage: "/details/petbouquet.webp",
  },
  petwild: {
    key: "petwild", audience: "all",
    coinCost: 3,
    title: "야생 친구 만난 우리 아이",
    subtitle: "우리 아이, 야생 친구들 사이로",
    emoji: "🦦",
    accent: "#5B8A5A",
    description: "거실의 우리 아이가 카피바라 온천, 미어캣 초원, 펭귄 해변에 자연스럽게 섞인 실사 장면으로. 강아지·고양이 모두.",
    examples: [
      { emoji: "🦦", accent: "#5B8A5A" },
    ],
    start: "petwild",
    detailImage: "/details/petwild.webp",
  },
  petflowerfield: {
    key: "petflowerfield", audience: "all",
    coinCost: 3,
    title: "꽃밭 인생샷(펫)",
    subtitle: "꽃밭 한가운데, 카메라 보는 우리 아이",
    emoji: "🌷",
    accent: "#C86AA0",
    description: "흔들린 산책 사진도 유채·핑크뮬리·라벤더·수국 밭 한가운데서 정면을 보는 인생샷으로. 강아지·고양이 모두.",
    examples: [
      { emoji: "🌷", accent: "#C86AA0" },
    ],
...
export function conceptForGo(go: string): Concept {
  ...
  if (go === "personalcolor") return CONCEPTS.personalcolor;
  if (go === "monoactor") return CONCEPTS.monoactor;
  if (go === "fortunecard") return CONCEPTS.fortunecard;
  if (go === "minichef") return CONCEPTS.minichef;
  if (go === "poolside") return CONCEPTS.poolside;
  if (go === "snowsnap") return CONCEPTS.snowsnap;
  if (go === "profileduo") return CONCEPTS.profileduo;
  if (go === "droneview") return CONCEPTS.droneview;
  if (go === "autumnsnap") return CONCEPTS.autumnsnap;
  if (go === "trenchlook") return CONCEPTS.trenchlook;
  if (go === "examcheer") return CONCEPTS.examcheer;
  ...
  if (go === "skisnap") return CONCEPTS.skisnap;
  if (go === "productscene") return CONCEPTS.productscene;
  if (go === "kidsdraw") return CONCEPTS.kidsdraw;
  if (go === "flatlay") return CONCEPTS.flatlay;
  if (go === "ghostfit") return CONCEPTS.ghostfit;
  if (go === "carad") return CONCEPTS.carad;
  if (go === "sketch2real") return CONCEPTS.sketch2real;
  if (go === "nailshot") return CONCEPTS.nailshot;
  if (go === "bouquetshot") return CONCEPTS.bouquetshot;
  if (go === "plantshot") return CONCEPTS.plantshot;
  ...
  if (go === "petwild") return CONCEPTS.petwild;
  if (go === "petflowerfield") return CONCEPTS.petflowerfield;
